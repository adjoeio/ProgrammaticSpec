Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => 'https://d2rv4xu1hi9oif.cloudfront.net/files/ios/0.0.2/AdjoeProgrammaticMintegralSDK.zip', :type => 'zip' }  
  ...
  spec.dependency 'AdjoeProgrammaticSDK', '0.0.2'
